...
void V4_FUZZY::V4_FUZZY_EnabledSubsystem_Init(B_EnabledSubsystem_V4_FUZZY_T
  *localB)
{
  /* SystemInitialize for SignalConversion generated from: '<S96>/In1' */
...
void V4_FUZZY::V4_FUZZ_EnabledSubsystem_p_Init(B_EnabledSubsystem_V4_FUZZY_d_T
  *localB)
{
  /* SystemInitialize for SignalConversion generated from: '<S97>/In1' */
  ...
  real_T y[101])
{
  ...
  for (int32_T i = 0; i < 101; i++) {
    ...
    if (V4_FUZZY_B.b != V4_FUZZY_B.c) {
      x_0 = x[i];
      if ((V4_FUZZY_B.b < x_0) && (x_0 < V4_FUZZY_B.c)) {
        y[i] = 1.0 / (V4_FUZZY_B.c - V4_FUZZY_B.b) * (V4_FUZZY_B.c - x_0);
      }
    }
...
void V4_FUZZY::step()
{
...

  {
    ...
    static const real_T b_2[3] = { -25.0, -25.0, -10.0 };

    static const real_T c[3] = { -18.0, -7.0, 0.0 };

    static const real_T d[3] = { 0.0, 7.0, 18.0 };

    static const real_T e[3] = { 10.0, 25.0, 25.0 };

    static const real_T f[3] = { -5.0, -5.0, 0.0 };

    static const real_T g[3] = { 0.0, 5.0, 5.0 };

    static const int8_T h[30] = { 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4, 5, 5, 5, 1, 1,
      2, 1, 2, 3, 1, 2, 3, 1, 2, 3, 1, 2, 3, 3 };

    static const real_T b_3[3] = { 0.0, 0.0, 0.15 };

    static const real_T c_0[3] = { 0.15, 0.35, 0.5 };

    static const real_T d_0[3] = { 0.7, 0.83, 0.95 };

    static const real_T e_0[3] = { 0.85, 1.0, 1.0 };
     ...
     */
    V4_FUZZY_B.Compare = (V4_FUZZY_X.Integrator_CSTATE[11] >= 100.05);

    /* Outputs for Enabled SubSystem: '<S58>/Hrgw' incorporates:
     *  EnablePort: '<S71>/Enable'
     */
    /* Outputs for Enabled SubSystem: '<S58>/Hqgw' incorporates:
     *  EnablePort: '<S70>/Enable'
     */
    /* Outputs for Enabled SubSystem: '<S58>/Hpgw' incorporates:
     *  EnablePort: '<S69>/Enable'
     */
    /* Outputs for Enabled SubSystem: '<S59>/Hwgw(s)' incorporates:
     *  EnablePort: '<S74>/Enable'
     */
    /* Outputs for Enabled SubSystem: '<S59>/Hvgw(s)' incorporates:
     *  EnablePort: '<S73>/Enable'
     */
    tmp_0 = (rtmIsMajorTimeStep((&V4_FUZZY_M)) &&
             (&V4_FUZZY_M)->Timing.TaskCounters.TID[1] == 0);

    /* End of Outputs for SubSystem: '<S59>/Hvgw(s)' */
    /* End of Outputs for SubSystem: '<S59>/Hwgw(s)' */
    /* End of Outputs for SubSystem: '<S58>/Hpgw' */
    /* End of Outputs for SubSystem: '<S58>/Hqgw' */
    /* End of Outputs for SubSystem: '<S58>/Hrgw' */
    if (tmp_0) {
    ...
    memcpy(&V4_FUZZY_B.x[0], &V4_FUZZY_X.Integrator_CSTATE[0], 12U * sizeof
           (real_T));
    ...
    V4_FUZZY_B.rtb_CoordinateTransformationC_o = V4_FUZZY_B.cosa *
      V4_FUZZY_B.cosb;

    /* MATLABSystem: '<Root>/Coordinate Transformation Conversion' */
    V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_B.sina *
      V4_FUZZY_B.sinb * V4_FUZZY_B.sinc +
      V4_FUZZY_B.rtb_CoordinateTransformationC_o * V4_FUZZY_B.cosc;
    V4_FUZZY_B.rtb_CoordinateTransformationC_o =
      V4_FUZZY_B.rtb_CoordinateTransformationC_o * V4_FUZZY_B.sinc -
      V4_FUZZY_B.cosc * V4_FUZZY_B.sina * V4_FUZZY_B.sinb;
    V4_FUZZY_B.rtb_CoordinateTransformationC_l = V4_FUZZY_B.cosa *
      V4_FUZZY_B.cosc * V4_FUZZY_B.sinb + V4_FUZZY_B.cosb * V4_FUZZY_B.sina *
      V4_FUZZY_B.sinc;
    V4_FUZZY_B.cosc = V4_FUZZY_B.cosb * V4_FUZZY_B.cosc * V4_FUZZY_B.sina -
     ...
     */
    V4_FUZZY_B.cosb = 0.0 * V4_FUZZY_B.rtb_CoordinateTransformationC_l +
      V4_FUZZY_B.rtb_CoordinateTransformationC_o;

    /* BusAssignment: '<Root>/Bus Assignment-IMU' incorporates:
     *  MATLAB Function: '<Root>/MATLAB Function-ned_to_imu'
     */
    V4_FUZZY_B.BusAssignmentIMU.orientation.x = -V4_FUZZY_B.cosb;

    /* MATLAB Function: '<Root>/MATLAB Function-ned_to_imu' incorporates:
     *  MATLAB Function: '<Root>/MATLAB Function-ned_to_gazebo'
     *  MATLAB Function: '<Root>/MATLAB Function-ned_to_odometry'
     */
    V4_FUZZY_B.sina = 0.0 * V4_FUZZY_B.rtb_CoordinateTransformationC_o -
     ...
     *  MATLAB Function: '<Root>/MATLAB Function-ned_to_odometry'
     */
    V4_FUZZY_B.sinb = 0.0 * V4_FUZZY_B.rtb_CoordinateTransformationC_b -
      V4_FUZZY_B.cosc;
     ...
     *  MATLAB Function: '<Root>/MATLAB Function-ned_to_odometry'
     */
    V4_FUZZY_B.sinc = 0.0 * V4_FUZZY_B.cosc +
     ...
     */
    V4_FUZZY_B.cosa = (&V4_FUZZY_M)->Timing.t[0];

    /* MATLAB Function: '<Root>/MATLAB Function-clocl' incorporates:
     *  Clock: '<Root>/Clock'
     */
    V4_FUZZY_B.CD_ih_IGE = floor(V4_FUZZY_B.cosa);
    ...
    V4_FUZZY_B.CD_ih_IGE = rt_roundd_snf((V4_FUZZY_B.cosa - V4_FUZZY_B.CD_ih_IGE)
      * 1.0E+9);
    if (V4_FUZZY_B.CD_ih_IGE < 4.294967296E+9) {
      if (V4_FUZZY_B.CD_ih_IGE >= 0.0) {
        rtb_nsec_0 = static_cast<uint32_T>(V4_FUZZY_B.CD_ih_IGE);
      } else {
        rtb_nsec_0 = 0U;
      }
    } else {
    ...
    /* MATLAB Function: '<Root>/MATLAB Function-ned_to_odometry' */
    V4_FUZZY_B.CD_ih_IGE = 0.7071 * V4_FUZZY_B.sina;
    V4_FUZZY_B.u2_deg = 0.7071 * -V4_FUZZY_B.cosb;

    /* BusAssignment: '<Root>/Bus Assignment-ODOM' incorporates:
     *  MATLAB Function: '<Root>/MATLAB Function-ned_to_odometry'
     */
    V4_FUZZY_B.BusAssignmentODOM.pose.pose.orientation.x = V4_FUZZY_B.u2_deg +
      V4_FUZZY_B.CD_ih_IGE;
    V4_FUZZY_B.BusAssignmentODOM.pose.pose.orientation.y = V4_FUZZY_B.CD_ih_IGE
      - V4_FUZZY_B.u2_deg;

    /* MATLAB Function: '<Root>/MATLAB Function-ned_to_odometry' */
    V4_FUZZY_B.CD_ih_IGE = 0.7071 * V4_FUZZY_B.sinc;
    V4_FUZZY_B.u2_deg = 0.7071 * V4_FUZZY_B.sinb;

    /* BusAssignment: '<Root>/Bus Assignment-ODOM' incorporates:
     *  MATLAB Function: '<Root>/MATLAB Function-clocl'
     *  MATLAB Function: '<Root>/MATLAB Function-ned_to_odometry'
     */
    V4_FUZZY_B.BusAssignmentODOM.pose.pose.orientation.z = V4_FUZZY_B.u2_deg +
      V4_FUZZY_B.CD_ih_IGE;
    V4_FUZZY_B.BusAssignmentODOM.pose.pose.orientation.w = V4_FUZZY_B.CD_ih_IGE
      - V4_FUZZY_B.u2_deg;
    ...
    memcpy(&V4_FUZZY_B.BusAssignmentODOM.child_frame_id[0], &V4_FUZZY_B.str_out
           [0], sizeof(uint8_T) << 7U);
    ...
    if (tmp_0) {
      ...
      MATLABFunctionned_to_PoseStampe
        (&V4_FUZZY_B.sf_MATLABFunctionned_to_PoseS_b);
    }
    ...
    V4_FUZZY_B.BusAssignmentPoseStaamped.pose.orientation.x = 0.7071 *
      V4_FUZZY_B.rtb_CoordinateTransformationC_l + -0.7071 *
      V4_FUZZY_B.rtb_CoordinateTransformationC_o;
    ...
    V4_FUZZY_B.BusAssignmentPoseStaamped.pose.orientation.z = -(0.7071 *
      V4_FUZZY_B.cosc + -0.7071 * V4_FUZZY_B.rtb_CoordinateTransformationC_b);
    V4_FUZZY_B.BusAssignmentPoseStaamped.pose.orientation.w = 0.7071 *
      V4_FUZZY_B.rtb_CoordinateTransformationC_b - -0.7071 * V4_FUZZY_B.cosc;
    ...
    if (tmp_0) {
      ...
      MATLABFunctionned_to_PoseStampe
        (&V4_FUZZY_B.sf_MATLABFunctionned_to_TwistSt);
    }
     ...
     */
    V4_FUZZY_B.Sum3 = 20.2 - V4_FUZZY_B.x[0];

    /* Derivative: '<Root>/Derivative4' */
    if ((V4_FUZZY_DW.TimeStampA >= V4_FUZZY_B.cosa) && (V4_FUZZY_DW.TimeStampB >=
         V4_FUZZY_B.cosa)) {
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = 0.0;
    } else {
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_DW.TimeStampA;
      lastU = &V4_FUZZY_DW.LastUAtTimeA;
      if (V4_FUZZY_DW.TimeStampA < V4_FUZZY_DW.TimeStampB) {
        if (V4_FUZZY_DW.TimeStampB < V4_FUZZY_B.cosa) {
          V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_DW.TimeStampB;
          lastU = &V4_FUZZY_DW.LastUAtTimeB;
        }
      } else if (V4_FUZZY_DW.TimeStampA >= V4_FUZZY_B.cosa) {
        V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_DW.TimeStampB;
        lastU = &V4_FUZZY_DW.LastUAtTimeB;
      }

      V4_FUZZY_B.rtb_CoordinateTransformationC_b = (V4_FUZZY_B.Sum3 - *lastU) /
    ...
    /* MATLAB Function: '<S11>/Evaluate Rule Antecedents' incorporates:
     *  SignalConversion generated from: '<S46>/ SFunction '
     */
    V4_FUZZY_B.rtb_CoordinateTransformationC_l = 0.0;
    V4_FUZZY_B.inputMFCache[0] = V4_FUZZY_trimf(V4_FUZZY_B.Sum3, b_2);
    V4_FUZZY_B.inputMFCache[1] = V4_FUZZY_trimf(V4_FUZZY_B.Sum3, c);
    V4_FUZZY_B.Dtot[0] = -2.0;
    V4_FUZZY_B.Dtot[1] = 0.0;
    V4_FUZZY_B.Dtot[2] = 2.0;
    V4_FUZZY_B.inputMFCache[2] = V4_FUZZY_trimf(V4_FUZZY_B.Sum3, V4_FUZZY_B.Dtot);
    V4_FUZZY_B.inputMFCache[3] = V4_FUZZY_trimf(V4_FUZZY_B.Sum3, d);
    V4_FUZZY_B.inputMFCache[4] = V4_FUZZY_trimf(V4_FUZZY_B.Sum3, e);
    V4_FUZZY_B.inputMFCache[5] = V4_FUZZY_trimf
      (V4_FUZZY_B.rtb_CoordinateTransformationC_b, f);
    V4_FUZZY_B.Dtot[0] = -2.0;
    V4_FUZZY_B.Dtot[1] = 0.0;
    V4_FUZZY_B.Dtot[2] = 2.0;
    ...
    V4_FUZZY_B.inputMFCache[7] = V4_FUZZY_trimf
      (V4_FUZZY_B.rtb_CoordinateTransformationC_b, g);
    for (i = 0; i < 15; i++) {
      V4_FUZZY_B.cosc = 1.0;
    ...
    /* MATLAB Function: '<S11>/Evaluate Rule Consequents' incorporates:
     *  Constant: '<S11>/Output Sample Points'
     */
    V4_FUZZY_trimf_l(V4_FUZZY_ConstP.OutputSamplePoints_Value_o1, b_3,
                     V4_FUZZY_B.dv);
    V4_FUZZY_trimf_l(V4_FUZZY_ConstP.OutputSamplePoints_Value_o1, c_0,
                     V4_FUZZY_B.dv1);
    V4_FUZZY_B.Dtot[0] = 0.35;
    V4_FUZZY_B.Dtot[1] = 0.5;
    V4_FUZZY_B.Dtot[2] = 0.65;
    V4_FUZZY_trimf_l(V4_FUZZY_ConstP.OutputSamplePoints_Value_o1,
                     V4_FUZZY_B.Dtot, V4_FUZZY_B.dv2);
    V4_FUZZY_trimf_l(V4_FUZZY_ConstP.OutputSamplePoints_Value_o1, d_0,
                     V4_FUZZY_B.dv3);
    V4_FUZZY_trimf_l(V4_FUZZY_ConstP.OutputSamplePoints_Value_o1, e_0,
                     V4_FUZZY_B.dv4);
    for (i = 0; i < 101; i++) {
    ...
    /* MATLAB Function: '<S11>/Defuzzify Outputs' incorporates:
     *  Constant: '<S11>/Output Sample Points'
     *  MATLAB Function: '<S11>/Evaluate Rule Antecedents'
     */
    if (V4_FUZZY_B.rtb_CoordinateTransformationC_l == 0.0) {
      V4_FUZZY_B.defuzzifiedOutputs = 0.5;
    } else {
      ...
      if (V4_FUZZY_B.rtb_CoordinateTransformationC_b == 0.0) {
        ...
        for (i = 0; i < 101; i++) {
          V4_FUZZY_B.defuzzifiedOutputs +=
            V4_FUZZY_ConstP.OutputSamplePoints_Value_o1[i] *
            V4_FUZZY_B.aggregatedOutputs[i];
        }
    ...
    /* End of MATLAB Function: '<S11>/Defuzzify Outputs' */
    ...
    if (tmp_0) {
      ...
      if (V4_FUZZY_B.SourceBlock_o1) {
        /* Switch: '<Root>/Switch2' */
        V4_FUZZY_B.Switch2_b = V4_FUZZY_B.EnabledSubsystem_a.In1.data;
      } else {
        /* Switch: '<Root>/Switch2' incorporates:
         *  UnitDelay: '<Root>/Unit Delay2'
         */
        V4_FUZZY_B.Switch2_b = V4_FUZZY_DW.UnitDelay2_DSTATE;
      }

      /* End of Switch: '<Root>/Switch2' */

      /* RateLimiter: '<Root>/Rate Limiter2' */
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_B.Switch2_b -
        V4_FUZZY_DW.PrevY;
      if (V4_FUZZY_B.rtb_CoordinateTransformationC_b > 0.0026000000000000003) {
        /* RateLimiter: '<Root>/Rate Limiter2' */
        V4_FUZZY_B.RateLimiter2 = V4_FUZZY_DW.PrevY + 0.0026000000000000003;
      } else if (V4_FUZZY_B.rtb_CoordinateTransformationC_b <
                 -0.0026000000000000003) {
        /* RateLimiter: '<Root>/Rate Limiter2' */
        V4_FUZZY_B.RateLimiter2 = V4_FUZZY_DW.PrevY - 0.0026000000000000003;
      } else {
        /* RateLimiter: '<Root>/Rate Limiter2' */
        V4_FUZZY_B.RateLimiter2 = V4_FUZZY_B.Switch2_b;
      }

      V4_FUZZY_DW.PrevY = V4_FUZZY_B.RateLimiter2;

      /* End of RateLimiter: '<Root>/Rate Limiter2' */
    }

    /* Sum: '<Root>/Sum5' */
    V4_FUZZY_B.Sum5 = V4_FUZZY_B.RateLimiter2 - V4_FUZZY_B.x[8];

    /* Derivative: '<Root>/Derivative3' */
    if ((V4_FUZZY_DW.TimeStampA_c >= V4_FUZZY_B.cosa) &&
        (V4_FUZZY_DW.TimeStampB_c >= V4_FUZZY_B.cosa)) {
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = 0.0;
    } else {
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_DW.TimeStampA_c;
      lastU = &V4_FUZZY_DW.LastUAtTimeA_g;
      if (V4_FUZZY_DW.TimeStampA_c < V4_FUZZY_DW.TimeStampB_c) {
        if (V4_FUZZY_DW.TimeStampB_c < V4_FUZZY_B.cosa) {
          V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_DW.TimeStampB_c;
          lastU = &V4_FUZZY_DW.LastUAtTimeB_f;
        }
      } else if (V4_FUZZY_DW.TimeStampA_c >= V4_FUZZY_B.cosa) {
        V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_DW.TimeStampB_c;
        lastU = &V4_FUZZY_DW.LastUAtTimeB_f;
      }

      V4_FUZZY_B.rtb_CoordinateTransformationC_b = (V4_FUZZY_B.Sum5 - *lastU) /
        (V4_FUZZY_B.cosa - V4_FUZZY_B.rtb_CoordinateTransformationC_b);
    }

    /* Outputs for Atomic SubSystem: '<Root>/Fuzzy Logic  Controller - Timon' */
    /* MATLAB Function: '<S10>/Evaluate Rule Antecedents' incorporates:
    ...
    /* MATLAB Function: '<S10>/Evaluate Rule Consequents' incorporates:
    ...
    /* End of MATLAB Function: '<S10>/Evaluate Rule Consequents' */

    /* MATLAB Function: '<S10>/Defuzzify Outputs' incorporates:
     *  Constant: '<S10>/Output Sample Points'
     *  MATLAB Function: '<S10>/Evaluate Rule Antecedents'
     */
    if (V4_FUZZY_B.rtb_CoordinateTransformationC_l == 0.0) {
      V4_FUZZY_B.defuzzifiedOutputs_p = 0.0;
    } else {
      ...
      if (V4_FUZZY_B.rtb_CoordinateTransformationC_b == 0.0) {
        ...
        V4_FUZZY_B.defuzzifiedOutputs_p = 1.0 /
          V4_FUZZY_B.rtb_CoordinateTransformationC_b *
          V4_FUZZY_B.rtb_CoordinateTransformationC_o;
      }
    }

    /* End of MATLAB Function: '<S10>/Defuzzify Outputs' */
     ...
     */
    if (-V4_FUZZY_B.defuzzifiedOutputs_p > 0.1) {
      /* Saturate: '<Root>/Saturation_roll_sp' */
      V4_FUZZY_B.Saturation_roll_sp = 0.1;
    } else if (-V4_FUZZY_B.defuzzifiedOutputs_p < -0.1) {
      /* Saturate: '<Root>/Saturation_roll_sp' */
      V4_FUZZY_B.Saturation_roll_sp = -0.1;
    } else {
      /* Saturate: '<Root>/Saturation_roll_sp' */
      V4_FUZZY_B.Saturation_roll_sp = -V4_FUZZY_B.defuzzifiedOutputs_p;
    }

    /* End of Saturate: '<Root>/Saturation_roll_sp' */

    /* Sum: '<Root>/Sum4' */
    V4_FUZZY_B.Sum4 = V4_FUZZY_B.Saturation_roll_sp - V4_FUZZY_B.x[6];

    /* Derivative: '<Root>/Derivative1' */
    if ((V4_FUZZY_DW.TimeStampA_p >= V4_FUZZY_B.cosa) &&
        (V4_FUZZY_DW.TimeStampB_f >= V4_FUZZY_B.cosa)) {
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = 0.0;
    } else {
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_DW.TimeStampA_p;
      lastU = &V4_FUZZY_DW.LastUAtTimeA_p;
      if (V4_FUZZY_DW.TimeStampA_p < V4_FUZZY_DW.TimeStampB_f) {
        if (V4_FUZZY_DW.TimeStampB_f < V4_FUZZY_B.cosa) {
          V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_DW.TimeStampB_f;
          lastU = &V4_FUZZY_DW.LastUAtTimeB_e;
        }
      } else if (V4_FUZZY_DW.TimeStampA_p >= V4_FUZZY_B.cosa) {
        V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_DW.TimeStampB_f;
        lastU = &V4_FUZZY_DW.LastUAtTimeB_e;
      }

      V4_FUZZY_B.rtb_CoordinateTransformationC_b = (V4_FUZZY_B.Sum4 - *lastU) /
        (V4_FUZZY_B.cosa - V4_FUZZY_B.rtb_CoordinateTransformationC_b);
    }

    /* Outputs for Atomic SubSystem: '<Root>/Fuzzy Logic  Controller - Aleron' */
    /* MATLAB Function: '<S7>/Evaluate Rule Antecedents' incorporates:
    ...
    /* MATLAB Function: '<S9>/Evaluate Rule Antecedents' incorporates:
     ...
     */
    if (V4_FUZZY_B.rtb_CoordinateTransformationC_l == 0.0) {
      V4_FUZZY_B.defuzzifiedOutputs_g = 0.0;
    } else {
      V4_FUZZY_B.rtb_CoordinateTransformationC_o = 0.0;
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = 0.0;
      for (i = 0; i < 101; i++) {
    ...
    V4_FUZZY_B.BusAssignmentMODELO.state.pose.orientation.y = V4_FUZZY_B.cosb;
    V4_FUZZY_B.BusAssignmentMODELO.state.pose.orientation.x = V4_FUZZY_B.sina;
    memcpy(&V4_FUZZY_B.BusAssignmentMODELO.state.name[0],
           &V4_FUZZY_B.stringOut_b[0], sizeof(uint8_T) << 7U);
     ...
     *  Memory: '<S30>/Memory'
     *  SignalConversion generated from: '<S51>/ SFunction '
     */
    ...
    if (V4_FUZZY_B.defuzzifiedOutputs_g <= 0.3490658503988659) {
      V4_FUZZY_B.u2 = V4_FUZZY_B.defuzzifiedOutputs_g;
    } else {
    ...
    if (V4_FUZZY_B.sinb < 0.5) {
      ...
      V4_FUZZY_B.cosa = V4_FUZZY_B.dv6[1] / V4_FUZZY_B.sinb;
      if ((V4_FUZZY_B.cosa >= 1.0) || rtIsNaN(V4_FUZZY_B.cosa)) {
        V4_FUZZY_B.cosa = 1.0;
      }

      if (V4_FUZZY_B.cosa <= -1.0) {
        V4_FUZZY_B.cosa = -1.0;
      }

      V4_FUZZY_B.cosa = asin(V4_FUZZY_B.cosa);
    }
    ...
    if ((-V4_FUZZY_B.x[11] + 0.3475 <= 0.001) || rtIsNaN(-V4_FUZZY_B.x[11] +
         0.3475)) {
      V4_FUZZY_B.cosb = 0.001;
    } else {
      V4_FUZZY_B.cosb = -V4_FUZZY_B.x[11] + 0.3475;
    }
    ...
    V4_FUZZY_B.CD_ih_IGE = V4_FUZZY_B.cosb / 0.3808;
    V4_FUZZY_B.cosb = ((V4_FUZZY_B.sinc - -0.06544984694978735) +
    ...
    V4_FUZZY_B.rtb_CoordinateTransformationC_o = (rt_powd_snf(V4_FUZZY_B.Vd1,
      ...
      0.9798630886207249 / 5.912947654095886 + 1.0) * V4_FUZZY_B.cosb;
    V4_FUZZY_B.rtb_CoordinateTransformationC_l = (rt_powd_snf
      (V4_FUZZY_B.CD_ih_IGE, 0.787) * 288.0 * exp(rt_powd_snf
      (V4_FUZZY_B.CD_ih_IGE, 0.327) * -9.14) * 0.9562859020012823 /
      5.35300902982722 + 1.0) * V4_FUZZY_B.rtb_CoordinateTransformationC_b;
    ...
    V4_FUZZY_B.CD_ih_IGE = ((1.0 - exp(rt_powd_snf(V4_FUZZY_B.CD_ih_IGE, 0.814) *
      ...
      * -3.88) * (V4_FUZZY_B.CD_ih_IGE * V4_FUZZY_B.CD_ih_IGE)) *
      (V4_FUZZY_B.rtb_CoordinateTransformationC_l *
       V4_FUZZY_B.rtb_CoordinateTransformationC_l / 18.943803701146454);
    ...
    V4_FUZZY_B.Ltot = (V4_FUZZY_B.rtb_CoordinateTransformationC_o * 0.0649 +
                       V4_FUZZY_B.rtb_CoordinateTransformationC_l * 0.02164) *
      V4_FUZZY_B.Q;
    V4_FUZZY_B.CQ = -0.019 * V4_FUZZY_B.cosa * 180.0 / 3.141592653589793;
    ...
    V4_FUZZY_B.Cl = ((V4_FUZZY_B.Memory1[0] + V4_FUZZY_B.x[3]) * 0.6977 /
                     V4_FUZZY_B.Fg_b_idx_2 * -2.0 + -0.12 * V4_FUZZY_B.cosa) +
      -0.5 * V4_FUZZY_B.u1;
    V4_FUZZY_B.u2 = ((exp(V4_FUZZY_B.Vd1 * -4.0) * -0.05 + -1.14 *
                      V4_FUZZY_B.sinc) + V4_FUZZY_B.q_aero * 0.093 /
                     V4_FUZZY_B.Fg_b_idx_2 * -5.0) + -3.0 * V4_FUZZY_B.u2;
    if (V4_FUZZY_B.defuzzifiedOutputs_p <= 0.2617993877991494) {
      V4_FUZZY_B.q_aero = V4_FUZZY_B.defuzzifiedOutputs_p;
    } else {
    ...
    V4_FUZZY_B.u1 = (((V4_FUZZY_B.Memory1[2] + V4_FUZZY_B.x[5]) * 0.6977 /
                      V4_FUZZY_B.Fg_b_idx_2 * -1.5 + -0.1146 * V4_FUZZY_B.cosa)
                     + -0.3 * V4_FUZZY_B.q_aero) + -0.05 * V4_FUZZY_B.u1;
    if (V4_FUZZY_B.defuzzifiedOutputs <= 1.0) {
    ...
    _mm_storeu_pd(&V4_FUZZY_B.dv6[0], _mm_mul_pd(_mm_mul_pd(_mm_mul_pd
      (_mm_set1_pd(9.81), _mm_set1_pd(cos(V4_FUZZY_B.x[7]))), _mm_set_pd(cos
      (V4_FUZZY_B.x[6]), sin(V4_FUZZY_B.x[6]))), _mm_set1_pd(1.2)));
    ...
    V4_FUZZY_B.R[3] = V4_FUZZY_B.R_tmp * V4_FUZZY_B.c_psi - V4_FUZZY_B.c_phi *
      V4_FUZZY_B.s_psi;
    V4_FUZZY_B.R_tmp_n = V4_FUZZY_B.c_phi * V4_FUZZY_B.s_the;
    V4_FUZZY_B.R[6] = V4_FUZZY_B.R_tmp_n * V4_FUZZY_B.c_psi + V4_FUZZY_B.s_phi *
      V4_FUZZY_B.s_psi;
    V4_FUZZY_B.R[1] = V4_FUZZY_B.c_the * V4_FUZZY_B.s_psi;
    V4_FUZZY_B.R[4] = V4_FUZZY_B.R_tmp * V4_FUZZY_B.s_psi + V4_FUZZY_B.c_phi *
      V4_FUZZY_B.c_psi;
    V4_FUZZY_B.R[7] = V4_FUZZY_B.R_tmp_n * V4_FUZZY_B.s_psi - V4_FUZZY_B.s_phi *
      V4_FUZZY_B.c_psi;
    ...
    V4_FUZZY_B.XDOT[3] = ((0.023669 * V4_FUZZY_B.L_dec + 0.001856 *
      V4_FUZZY_B.FE2_b_idx_2) - (-2.6338496E-5 * V4_FUZZY_B.x[3] +
      0.000144843342 * V4_FUZZY_B.x[5]) * V4_FUZZY_B.x[4]) / 0.000191043437;
    ...
    V4_FUZZY_B.XDOT[5] = ((-2.6338496E-5 * V4_FUZZY_B.x[5] +
      -7.443598999999999E-5 * V4_FUZZY_B.x[3]) * V4_FUZZY_B.x[4] + (0.001856 *
      V4_FUZZY_B.L_dec + 0.008217 * V4_FUZZY_B.FE2_b_idx_2)) / 0.000191043437;
    ...
    V4_FUZZY_B.XDOT[24] = V4_FUZZY_B.cosa;
    V4_FUZZY_B.XDOT[25] = V4_FUZZY_B.cosb;
    ...
    V4_FUZZY_B.XDOT[28] = V4_FUZZY_B.rtb_CoordinateTransformationC_l;
    ...
    /* UnitConversion: '<S66>/Unit Conversion' incorporates:
    ...
    /* Saturate: '<S93>/Limit Function 10ft to 1000ft' incorporates:
     *  Saturate: '<S76>/Limit Height h<1000ft'
     */
    if (V4_FUZZY_B.sina > 1000.0) {
      V4_FUZZY_B.sinc = 1000.0;
      V4_FUZZY_B.cosa = 1000.0;
    } else {
      ...
      if (V4_FUZZY_B.sina < 0.0) {
        ...
        V4_FUZZY_B.cosa = V4_FUZZY_B.sina;
      }
    }

    /* End of Saturate: '<S93>/Limit Function 10ft to 1000ft' */

    /* Fcn: '<S93>/Low Altitude Scale Length' */
    V4_FUZZY_B.rtb_CoordinateTransformationC_l = V4_FUZZY_B.sinc / rt_powd_snf
      (0.000823 * V4_FUZZY_B.sinc + 0.177, 1.2);

    /* Product: '<S76>/sigma_ug, sigma_vg' incorporates:
     *  Fcn: '<S76>/Low Altitude Intensity'
     */
    V4_FUZZY_B.cosb = 1.0 / rt_powd_snf(0.000823 * V4_FUZZY_B.cosa + 0.177, 0.4)
      * V4_FUZZY_ConstB.sigma_wg;

    /* Interpolation_n-D: '<S75>/Medium//High Altitude Intensity' incorporates:
     *  PreLookup: '<S75>/PreLook-Up Index Search  (altitude)'
     *  PreLookup: '<S75>/PreLook-Up Index Search  (prob of exceed)'
     *  Sqrt: '<S30>/Sqrt'
     */
    V4_FUZZY_B.bpIndex[0] = plook_bincpa(V4_FUZZY_B.sina,
      V4_FUZZY_ConstP.PreLookUpIndexSearchaltitude_Br, 11U, &V4_FUZZY_B.cosa,
      &V4_FUZZY_DW.PreLookUpIndexSearchaltitude_DW);
    V4_FUZZY_B.Lw[0] = V4_FUZZY_B.cosa;
    V4_FUZZY_B.Lw[1] = V4_FUZZY_ConstB.PreLookUpIndexSearchprobofe;
    V4_FUZZY_B.bpIndex[1] = V4_FUZZY_ConstB.PreLookUpIndexSearchprobo_g;
    V4_FUZZY_B.cosa = intrp2d_la_pw(V4_FUZZY_B.bpIndex, V4_FUZZY_B.Lw,
      V4_FUZZY_ConstP.MediumHighAltitudeIntensity_Tab, 12U,
    ...
    if (tmp_0) {
      ...
      /* Outputs for Enabled SubSystem: '<S59>/Hugw(s)' incorporates:
      ...
      if (rtsiIsModeUpdateTimeStep(&(&V4_FUZZY_M)->solverInfo) &&
        ...
        /* InitializeConditions for Integrator: '<S72>/ug_p' */
        V4_FUZZY_X.ug_p_CSTATE[0] = 0.0;
        V4_FUZZY_X.ug_p_CSTATE[1] = 0.0;
        V4_FUZZY_DW.Hugws_MODE = true;
      }

      /* End of Outputs for SubSystem: '<S59>/Hugw(s)' */
    }
    ...
    if (V4_FUZZY_DW.Hugws_MODE) {
      /* Product: '<S72>/Lug//V' */
      V4_FUZZY_B.rtb_CoordinateTransformationC_o =
        V4_FUZZY_B.rtb_CoordinateTransformationC_l / V4_FUZZY_B.sinb;
      V4_FUZZY_B.rtb_CoordinateTransformationC_b =
        V4_FUZZY_ConstB.UnitConversion_c / V4_FUZZY_B.sinb;
      ...
      tmp_1 = _mm_div_pd(_mm_sub_pd(_mm_mul_pd(_mm_set_pd(sqrt
        (0.6366197723675814 * V4_FUZZY_B.rtb_CoordinateTransformationC_b), sqrt
        (0.6366197723675814 * V4_FUZZY_B.rtb_CoordinateTransformationC_o)),
        _mm_set1_pd(V4_FUZZY_B.Product[0])), _mm_loadu_pd
        (&V4_FUZZY_X.ug_p_CSTATE[0])), _mm_set_pd
                         (V4_FUZZY_B.rtb_CoordinateTransformationC_b,
                          V4_FUZZY_B.rtb_CoordinateTransformationC_o));
    ...
    /* Gain: '<S65>/Lv' */
    V4_FUZZY_B.rtb_CoordinateTransformationC_b =
      V4_FUZZY_ConstB.UnitConversion_c;
    ...
    if (tmp_0 && rtsiIsModeUpdateTimeStep(&(&V4_FUZZY_M)->solverInfo) &&
      ...
      /* InitializeConditions for Integrator: '<S73>/vg_p1' */
      V4_FUZZY_X.vg_p1_CSTATE[0] = 0.0;

      /* InitializeConditions for Integrator: '<S73>/vgw_p2' */
    ...
    if (V4_FUZZY_DW.Hvgws_MODE) {
      /* Product: '<S73>/Lvg//V' incorporates:
       *  Gain: '<S65>/Lv'
       */
      V4_FUZZY_B.rtb_CoordinateTransformationC_o =
        V4_FUZZY_B.rtb_CoordinateTransformationC_l / V4_FUZZY_B.sinb;
       ...
       *  Gain: '<S73>/(1//pi)'
       *  Integrator: '<S73>/vg_p1'
       *  Product: '<S73>/Lug//V1'
       *  Sqrt: '<S73>/sqrt'
       *  Sum: '<S73>/Sum'
       */
      V4_FUZZY_B.rtb_CoordinateTransformationC_l = (sqrt(0.3183098861837907 *
        V4_FUZZY_B.rtb_CoordinateTransformationC_o) * V4_FUZZY_B.Product[1] -
        V4_FUZZY_X.vg_p1_CSTATE[0]) / V4_FUZZY_B.rtb_CoordinateTransformationC_o;
      V4_FUZZY_B.w_g[0] = V4_FUZZY_B.rtb_CoordinateTransformationC_l;

      /* Product: '<S73>/w ' incorporates:
       *  Gain: '<S73>/sqrt(3)'
       *  Integrator: '<S73>/vg_p1'
       *  Integrator: '<S73>/vgw_p2'
       *  Product: '<S73>/Lvg//V '
       *  Sum: '<S73>/Sum1'
       */
      V4_FUZZY_B.w_e[0] = (V4_FUZZY_B.rtb_CoordinateTransformationC_l *
                           V4_FUZZY_B.rtb_CoordinateTransformationC_o *
                           1.7320508075688772 + (V4_FUZZY_X.vg_p1_CSTATE[0] -
        V4_FUZZY_X.vgw_p2_CSTATE[0])) /
        V4_FUZZY_B.rtb_CoordinateTransformationC_o;
      ...
      V4_FUZZY_B.rtb_CoordinateTransformationC_l = (sqrt(0.3183098861837907 *
        V4_FUZZY_B.rtb_CoordinateTransformationC_o) * V4_FUZZY_B.Product[1] -
        V4_FUZZY_X.vg_p1_CSTATE[1]) / V4_FUZZY_B.rtb_CoordinateTransformationC_o;
      V4_FUZZY_B.w_g[1] = V4_FUZZY_B.rtb_CoordinateTransformationC_l;
       ...
       *  Sum: '<S73>/Sum1'
       */
      V4_FUZZY_B.w_e[1] = (V4_FUZZY_B.rtb_CoordinateTransformationC_l *
                           V4_FUZZY_B.rtb_CoordinateTransformationC_o *
                           1.7320508075688772 + (V4_FUZZY_X.vg_p1_CSTATE[1] -
        V4_FUZZY_X.vgw_p2_CSTATE[1])) /
        V4_FUZZY_B.rtb_CoordinateTransformationC_o;

      /* Product: '<S73>/w 1' incorporates:
       *  Integrator: '<S73>/vgw_p2'
       */
      tmp_1 = _mm_mul_pd(_mm_set_pd(V4_FUZZY_B.cosa, V4_FUZZY_B.cosb),
                         _mm_loadu_pd(&V4_FUZZY_X.vgw_p2_CSTATE[0]));
    ...
    /* Gain: '<S65>/Lw' */
    V4_FUZZY_B.Lw[1] = V4_FUZZY_ConstB.UnitConversion_c;
    ...
    if (tmp_0 && rtsiIsModeUpdateTimeStep(&(&V4_FUZZY_M)->solverInfo) &&
      ...
      /* InitializeConditions for Integrator: '<S74>/wg_p1' */
      V4_FUZZY_X.wg_p1_CSTATE[0] = 0.0;

      /* InitializeConditions for Integrator: '<S74>/wg_p2' */
    ...
    if (V4_FUZZY_DW.Hwgws_MODE) {
      /* Product: '<S74>/Lwg//V' incorporates:
       *  Gain: '<S65>/Lw'
       */
      V4_FUZZY_B.cosb = V4_FUZZY_B.sinc / V4_FUZZY_B.sinb;

      /* Product: '<S74>/w' incorporates:
       *  Gain: '<S74>/1//pi'
       *  Integrator: '<S74>/wg_p1'
       *  Product: '<S74>/Lug//V1'
       *  Sqrt: '<S74>/sqrt1'
       *  Sum: '<S74>/Sum'
       */
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = (sqrt(0.3183098861837907 *
        V4_FUZZY_B.cosb) * V4_FUZZY_B.Product[2] - V4_FUZZY_X.wg_p1_CSTATE[0]) /
        V4_FUZZY_B.cosb;
      V4_FUZZY_B.w[0] = V4_FUZZY_B.rtb_CoordinateTransformationC_b;

      /* Product: '<S74>/w ' incorporates:
       *  Integrator: '<S74>/wg_p1'
       *  Integrator: '<S74>/wg_p2'
       *  Product: '<S74>/Lwg//V'
       *  Product: '<S74>/Lwg//V '
       *  Sum: '<S74>/Sum1'
       */
      V4_FUZZY_B.w_a[0] = (V4_FUZZY_B.rtb_CoordinateTransformationC_b *
                           V4_FUZZY_ConstB.sqrt_a * V4_FUZZY_B.cosb +
                           (V4_FUZZY_X.wg_p1_CSTATE[0] -
                            V4_FUZZY_X.wg_p2_CSTATE[0])) / V4_FUZZY_B.cosb;

      /* Product: '<S74>/Lwg//V' */
      V4_FUZZY_B.cosb = V4_FUZZY_B.Lw[1] / V4_FUZZY_B.sinb;
       ...
       */
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = (sqrt(0.3183098861837907 *
        V4_FUZZY_B.cosb) * V4_FUZZY_B.Product[2] - V4_FUZZY_X.wg_p1_CSTATE[1]) /
        V4_FUZZY_B.cosb;
      ...
      V4_FUZZY_B.w_a[1] = (V4_FUZZY_B.rtb_CoordinateTransformationC_b *
                           V4_FUZZY_ConstB.sqrt_a * V4_FUZZY_B.cosb +
                           (V4_FUZZY_X.wg_p1_CSTATE[1] -
                            V4_FUZZY_X.wg_p2_CSTATE[1])) / V4_FUZZY_B.cosb;

      /* Product: '<S74>/Lwg//V 1' incorporates:
       *  Integrator: '<S74>/wg_p2'
       */
      tmp_1 = _mm_mul_pd(_mm_set_pd(V4_FUZZY_B.cosa, V4_FUZZY_ConstB.sigma_wg),
                         _mm_loadu_pd(&V4_FUZZY_X.wg_p2_CSTATE[0]));
    ...
    V4_FUZZY_B.rtb_CoordinateTransformationC_l = cos(V4_FUZZY_B.x[6]);
    ...
    V4_FUZZY_B.RotationAnglestoDirectionCo[0] = (V4_FUZZY_B.FA_b_idx_0 *
      V4_FUZZY_B.cosb + 0.0 * V4_FUZZY_B.rtb_CoordinateTransformationC_o) +
      V4_FUZZY_B.Cl;
    V4_FUZZY_B.u2 = V4_FUZZY_B.Ltot * 0.0;
    V4_FUZZY_B.RotationAnglestoDirectionCo[1] = (V4_FUZZY_B.cosb *
    ...
    V4_FUZZY_B.RotationAnglestoDirectionCo[2] = (V4_FUZZY_B.cosb *
      V4_FUZZY_B.cosc + V4_FUZZY_B.rtb_CoordinateTransformationC_o *
      V4_FUZZY_B.CQ) + V4_FUZZY_B.u1;
    V4_FUZZY_B.RotationAnglestoDirectionCo[3] = (V4_FUZZY_B.FA_b_idx_0 *
      V4_FUZZY_B.rtb_CoordinateTransformationC_b + 0.0 *
      V4_FUZZY_B.rtb_CoordinateTransformationC_l) + V4_FUZZY_B.Cl;
    V4_FUZZY_B.RotationAnglestoDirectionCo[4] =
      (V4_FUZZY_B.rtb_CoordinateTransformationC_b * V4_FUZZY_B.FA_b_idx_2 +
       V4_FUZZY_B.u2_deg * V4_FUZZY_B.rtb_CoordinateTransformationC_l) +
      V4_FUZZY_B.u2;
    V4_FUZZY_B.RotationAnglestoDirectionCo[5] =
      (V4_FUZZY_B.rtb_CoordinateTransformationC_b * V4_FUZZY_B.cosc +
       V4_FUZZY_B.rtb_CoordinateTransformationC_l * V4_FUZZY_B.CQ) +
      V4_FUZZY_B.u1;
    ...
    /* If: '<S64>/if Height < Max low altitude  elseif Height > Min isotropic altitude ' incorporates:
     *  Constant: '<S85>/max_height_low'
    ...
    switch (rtAction) {
     case 0:
      /* Outputs for IfAction SubSystem: '<S64>/Low altitude  velocities' incorporates:
       ...
       */
      V4_FUZZY_B.cosb = sin(V4_FUZZY_ConstB.UnitConversion);
      ...
      _mm_storeu_pd(&V4_FUZZY_B.Product_k[0], _mm_add_pd(_mm_mul_pd(_mm_set_pd
        (V4_FUZZY_B.cosb, V4_FUZZY_B.w1_c[0]), _mm_set_pd(V4_FUZZY_B.w1_c[0],
        V4_FUZZY_B.rtb_CoordinateTransformationC_b)), _mm_mul_pd(_mm_mul_pd
        (_mm_set_pd(V4_FUZZY_B.w1[0], V4_FUZZY_B.cosb), _mm_set_pd
         (V4_FUZZY_B.rtb_CoordinateTransformationC_b, V4_FUZZY_B.w1[0])),
        _mm_set_pd(1.0, -1.0))));

      /* Product: '<S91>/Product' incorporates:
       *  Angle2Dcm: '<S30>/Rotation Angles to Direction Cosine Matrix'
       *  Concatenate: '<S91>/Vector Concatenate'
       *  Product: '<S92>/Product1'
       *  Product: '<S92>/Product2'
       *  Reshape: '<S91>/Reshape1'
       *  Sum: '<S92>/Sum'
       */
      V4_FUZZY_B.cosb = 0.0;
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = 0.0;
        ...
        tmp_1 = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd
          ...
          (V4_FUZZY_B.Product_k[i])), _mm_set_pd
                           (V4_FUZZY_B.rtb_CoordinateTransformationC_b,
                            V4_FUZZY_B.cosb));
        _mm_storeu_pd(&V4_FUZZY_B.dv6[0], tmp_1);
        V4_FUZZY_B.cosb = V4_FUZZY_B.dv6[0];
      ...
      V4_FUZZY_B.wbe_b[0] = V4_FUZZY_B.cosb;

      /* End of Product: '<S91>/Product' */
      /* End of Outputs for SubSystem: '<S64>/Low altitude  velocities' */
      break;

     case 1:
      /* Outputs for IfAction SubSystem: '<S64>/Medium//High  altitude velocities' incorporates:
      ...
      /* End of Outputs for SubSystem: '<S64>/Medium//High  altitude velocities' */
      break;

     default:
      /* Outputs for IfAction SubSystem: '<S64>/Interpolate  velocities' incorporates:
       *  ActionPort: '<S85>/Action Port'
       */
      /* Trigonometry: '<S90>/Trigonometric Function' incorporates:
       *  UnitConversion: '<S57>/Unit Conversion'
       */
      V4_FUZZY_B.cosb = sin(V4_FUZZY_ConstB.UnitConversion);
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = cos
      ...
      V4_FUZZY_B.Product_k[0] = V4_FUZZY_B.cosb;
      ...
      /* End of Outputs for SubSystem: '<S64>/Interpolate  velocities' */
      break;
    }

    /* End of If: '<S64>/if Height < Max low altitude  elseif Height > Min isotropic altitude ' */
    ...
    if (tmp_0) {
      ...
      V4_FUZZY_EnabledSubsystem(V4_FUZZY_B.SourceBlock_o1_h,
        &rtb_SourceBlock_o2_j, &V4_FUZZY_B.EnabledSubsystem_pt);
    ...
    if (V4_FUZZY_B.EnabledSubsystem_pt.In1.data) {
      ...
      _mm_storeu_pd(&V4_FUZZY_B.Switch[0], tmp_1);

      /* Switch: '<S30>/Switch' incorporates:
       *  UnitConversion: '<S50>/Unit Conversion'
       */
      V4_FUZZY_B.Switch[2] = 0.3048 * V4_FUZZY_B.wbe_b[2];
    } else {
      /* Switch: '<S30>/Switch' incorporates:
       *  Constant: '<S30>/Constant'
       */
      V4_FUZZY_B.Switch[0] = 0.0;
      V4_FUZZY_B.Switch[1] = 0.0;
      V4_FUZZY_B.Switch[2] = 0.0;
    }
    ...
    if (tmp_0 && rtsiIsModeUpdateTimeStep(&(&V4_FUZZY_M)->solverInfo) &&
      ...
      /* InitializeConditions for Integrator: '<S69>/pgw_p' */
    ...
    if (V4_FUZZY_DW.Hpgw_MODE) {
      /* Fcn: '<S69>/sqrt(0.8//V)' */
      V4_FUZZY_B.cosb = sqrt(0.8 / V4_FUZZY_B.sinb);

      /* Product: '<S69>/w3' */
      V4_FUZZY_B.rtb_CoordinateTransformationC_b = V4_FUZZY_B.sinb *
        V4_FUZZY_ConstB.w4;

      /* Product: '<S69>/w' incorporates:
       *  Fcn: '<S69>/sqrt(0.8//V)'
       *  Gain: '<S65>/Lw'
       *  Integrator: '<S69>/pgw_p'
       *  Math: '<S69>/L^1//3'
       *  Product: '<S69>/Lug//V1'
       *  Product: '<S69>/w1'
       *  Product: '<S69>/w2'
       *  Sum: '<S69>/Sum'
       */
      V4_FUZZY_B.w_o[0] = (V4_FUZZY_B.cosb / rt_powd_snf(V4_FUZZY_B.sinc,
        0.3333333333333333) * V4_FUZZY_ConstB.u16 * V4_FUZZY_B.Product[3] -
                           V4_FUZZY_X.pgw_p_CSTATE[0]) *
        V4_FUZZY_B.rtb_CoordinateTransformationC_b;

      /* Math: '<S69>/L^1//3' */
      if (V4_FUZZY_B.Lw[1] < 0.0) {
        V4_FUZZY_B.q_aero = -rt_powd_snf(-V4_FUZZY_B.Lw[1], 0.3333333333333333);
      } else {
        V4_FUZZY_B.q_aero = rt_powd_snf(V4_FUZZY_B.Lw[1], 0.3333333333333333);
      }
       ...
       *  Sum: '<S69>/Sum'
       */
      V4_FUZZY_B.w_o[1] = (V4_FUZZY_B.cosb / V4_FUZZY_B.q_aero *
                           V4_FUZZY_ConstB.u16 * V4_FUZZY_B.Product[3] -
                           V4_FUZZY_X.pgw_p_CSTATE[1]) *
        V4_FUZZY_B.rtb_CoordinateTransformationC_b;

      /* Product: '<S69>/sigma_w' incorporates:
       *  Integrator: '<S69>/pgw_p'
       */
      tmp_1 = _mm_mul_pd(_mm_set_pd(V4_FUZZY_B.cosa, V4_FUZZY_ConstB.sigma_wg),
                         _mm_loadu_pd(&V4_FUZZY_X.pgw_p_CSTATE[0]));
    ...
    if (tmp_0 && rtsiIsModeUpdateTimeStep(&(&V4_FUZZY_M)->solverInfo) &&
      ...
      /* InitializeConditions for Integrator: '<S70>/qgw_p' */
    ...
    if (V4_FUZZY_DW.Hqgw_MODE) {
      ...
      /* Product: '<S70>/w' incorporates:
       *  Integrator: '<S70>/qgw_p'
       *  Product: '<S70>/wg//V'
       *  Sum: '<S70>/Sum'
       */
      V4_FUZZY_B.cosa = (V4_FUZZY_B.LwgV1[0] / V4_FUZZY_B.sinb -
                         V4_FUZZY_X.qgw_p_CSTATE[0]) * (V4_FUZZY_B.sinc /
        V4_FUZZY_ConstB.UnitConversion_n);
      V4_FUZZY_B.w_e0[0] = V4_FUZZY_B.cosa;

      /* UnaryMinus: '<S70>/Unary Minus' */
      V4_FUZZY_B.UnaryMinus[0] = -V4_FUZZY_B.cosa;
       ...
       *  Sum: '<S70>/Sum'
       */
      V4_FUZZY_B.cosa = (V4_FUZZY_B.LwgV1[1] / V4_FUZZY_B.sinb -
                         V4_FUZZY_X.qgw_p_CSTATE[1]) * (V4_FUZZY_B.sinc /
        V4_FUZZY_ConstB.UnitConversion_n);
      V4_FUZZY_B.w_e0[1] = V4_FUZZY_B.cosa;

      /* UnaryMinus: '<S70>/Unary Minus' */
      V4_FUZZY_B.UnaryMinus[1] = -V4_FUZZY_B.cosa;
    }
    ...
    if (tmp_0 && rtsiIsModeUpdateTimeStep(&(&V4_FUZZY_M)->solverInfo) &&
      ...
      /* InitializeConditions for Integrator: '<S71>/rgw_p' */
    ...
    if (V4_FUZZY_DW.Hrgw_MODE) {
      /* Product: '<S71>/vg//V' incorporates:
       *  Gain: '<S71>/pi//3'
       *  Integrator: '<S71>/rgw_p'
       *  Product: '<S71>/w'
       */
    ...
    /* If: '<S63>/if Height < Max low altitude  elseif Height > Min isotropic altitude ' incorporates:
     *  Constant: '<S77>/max_height_low'
    ...
    switch (rtAction) {
     case 0:
      /* Outputs for IfAction SubSystem: '<S63>/Low altitude  rates' incorporates:
      ...
      _mm_storeu_pd(&V4_FUZZY_B.Product_k[0], _mm_add_pd(_mm_mul_pd(_mm_set_pd
        (V4_FUZZY_B.sina, V4_FUZZY_B.sigma_w[0]), _mm_set_pd(V4_FUZZY_B.sigma_w
        [0], V4_FUZZY_B.sinb)), _mm_mul_pd(_mm_mul_pd(_mm_set_pd
        (V4_FUZZY_B.UnaryMinus[0], V4_FUZZY_B.sina), _mm_set_pd(V4_FUZZY_B.sinb,
        V4_FUZZY_B.UnaryMinus[0])), _mm_set_pd(1.0, -1.0))));
      ...
      /* End of Outputs for SubSystem: '<S63>/Low altitude  rates' */
      break;

     case 1:
      /* Outputs for IfAction SubSystem: '<S63>/Medium//High  altitude rates' incorporates:
      ...
      /* End of Outputs for SubSystem: '<S63>/Medium//High  altitude rates' */
      break;

     default:
      /* Outputs for IfAction SubSystem: '<S63>/Interpolate  rates' incorporates:
      ...
      _mm_storeu_pd(&V4_FUZZY_B.wbe_b[0], _mm_add_pd(_mm_mul_pd(_mm_set_pd
        (V4_FUZZY_B.sinb, V4_FUZZY_B.sigma_w[0]), _mm_set_pd(V4_FUZZY_B.sigma_w
        [0], V4_FUZZY_B.sinc)), _mm_mul_pd(_mm_mul_pd(_mm_set_pd
        (V4_FUZZY_B.UnaryMinus[0], V4_FUZZY_B.sinb), _mm_set_pd(V4_FUZZY_B.sinc,
        V4_FUZZY_B.UnaryMinus[0])), _mm_set_pd(1.0, -1.0))));
      ...
      /* End of Outputs for SubSystem: '<S63>/Interpolate  rates' */
      break;
    }

    /* End of If: '<S63>/if Height < Max low altitude  elseif Height > Min isotropic altitude ' */
    if (tmp_0) {
    ...
    if (tmp_0) {
      /* Gain: '<S48>/Output' incorporates:
       *  RandomNumber: '<S48>/White Noise'
       */
    ...
    V4_FUZZY_B.Power = sqrt((V4_FUZZY_B.x[0] * V4_FUZZY_B.x[0] + V4_FUZZY_B.x[1]
      * V4_FUZZY_B.x[1]) + V4_FUZZY_B.x[2] * V4_FUZZY_B.x[2]) * V4_FUZZY_B.XDOT
      [34];
    ...
    /* Sum: '<S30>/SumOLA' */
    V4_FUZZY_B.SumOLA[0] = V4_FUZZY_B.Switch[0];
    V4_FUZZY_B.SumOLA[1] = V4_FUZZY_B.Switch[1] + V4_FUZZY_B.Switch2;
    V4_FUZZY_B.SumOLA[2] = V4_FUZZY_B.Switch[2];
  ...
  if (rtmIsMajorTimeStep((&V4_FUZZY_M))) {
    real_T *lastU;
    boolean_T tmp;
    tmp = (rtmIsMajorTimeStep((&V4_FUZZY_M)) &&
           (&V4_FUZZY_M)->Timing.TaskCounters.TID[1] == 0);
    if (tmp) {
    ...
    if (V4_FUZZY_DW.TimeStampA == (rtInf)) {
      V4_FUZZY_DW.TimeStampA = (&V4_FUZZY_M)->Timing.t[0];
      lastU = &V4_FUZZY_DW.LastUAtTimeA;
    } else if (V4_FUZZY_DW.TimeStampB == (rtInf)) {
      V4_FUZZY_DW.TimeStampB = (&V4_FUZZY_M)->Timing.t[0];
      lastU = &V4_FUZZY_DW.LastUAtTimeB;
    } else if (V4_FUZZY_DW.TimeStampA < V4_FUZZY_DW.TimeStampB) {
      V4_FUZZY_DW.TimeStampA = (&V4_FUZZY_M)->Timing.t[0];
      lastU = &V4_FUZZY_DW.LastUAtTimeA;
    } else {
      V4_FUZZY_DW.TimeStampB = (&V4_FUZZY_M)->Timing.t[0];
    ...
    *lastU = V4_FUZZY_B.Sum3;
    ...
    if (V4_FUZZY_DW.TimeStampA_c == (rtInf)) {
      V4_FUZZY_DW.TimeStampA_c = (&V4_FUZZY_M)->Timing.t[0];
      lastU = &V4_FUZZY_DW.LastUAtTimeA_g;
    } else if (V4_FUZZY_DW.TimeStampB_c == (rtInf)) {
      V4_FUZZY_DW.TimeStampB_c = (&V4_FUZZY_M)->Timing.t[0];
      lastU = &V4_FUZZY_DW.LastUAtTimeB_f;
    } else if (V4_FUZZY_DW.TimeStampA_c < V4_FUZZY_DW.TimeStampB_c) {
      V4_FUZZY_DW.TimeStampA_c = (&V4_FUZZY_M)->Timing.t[0];
      lastU = &V4_FUZZY_DW.LastUAtTimeA_g;
    } else {
      V4_FUZZY_DW.TimeStampB_c = (&V4_FUZZY_M)->Timing.t[0];
    ...
    *lastU = V4_FUZZY_B.Sum5;

    /* End of Update for Derivative: '<Root>/Derivative3' */

    /* Update for Derivative: '<Root>/Derivative1' */
    if (V4_FUZZY_DW.TimeStampA_p == (rtInf)) {
      V4_FUZZY_DW.TimeStampA_p = (&V4_FUZZY_M)->Timing.t[0];
      lastU = &V4_FUZZY_DW.LastUAtTimeA_p;
    } else if (V4_FUZZY_DW.TimeStampB_f == (rtInf)) {
      V4_FUZZY_DW.TimeStampB_f = (&V4_FUZZY_M)->Timing.t[0];
      lastU = &V4_FUZZY_DW.LastUAtTimeB_e;
    } else if (V4_FUZZY_DW.TimeStampA_p < V4_FUZZY_DW.TimeStampB_f) {
      V4_FUZZY_DW.TimeStampA_p = (&V4_FUZZY_M)->Timing.t[0];
      lastU = &V4_FUZZY_DW.LastUAtTimeA_p;
    } else {
      V4_FUZZY_DW.TimeStampB_f = (&V4_FUZZY_M)->Timing.t[0];
    ...
    *lastU = V4_FUZZY_B.Sum2;
    ...
    if (tmp) {
      ...
      /* Update for RandomNumber: '<S48>/White Noise' */
...
void V4_FUZZY::V4_FUZZY_derivatives()
{
  ...
  /* Derivatives for Enabled SubSystem: '<S59>/Hugw(s)' */
  if (V4_FUZZY_DW.Hugws_MODE) {
    /* Derivatives for Integrator: '<S72>/ug_p' */
  ...
  /* End of Derivatives for SubSystem: '<S59>/Hugw(s)' */

  /* Derivatives for Enabled SubSystem: '<S59>/Hvgw(s)' */
  if (V4_FUZZY_DW.Hvgws_MODE) {
    /* Derivatives for Integrator: '<S73>/vg_p1' */
    _rtXdot->vg_p1_CSTATE[0] = V4_FUZZY_B.w_g[0];

    /* Derivatives for Integrator: '<S73>/vgw_p2' */
  ...
  /* End of Derivatives for SubSystem: '<S59>/Hvgw(s)' */

  /* Derivatives for Enabled SubSystem: '<S59>/Hwgw(s)' */
  if (V4_FUZZY_DW.Hwgws_MODE) {
    /* Derivatives for Integrator: '<S74>/wg_p1' */
    _rtXdot->wg_p1_CSTATE[0] = V4_FUZZY_B.w[0];

    /* Derivatives for Integrator: '<S74>/wg_p2' */
  ...
  /* End of Derivatives for SubSystem: '<S59>/Hwgw(s)' */

  /* Derivatives for Enabled SubSystem: '<S58>/Hpgw' */
  if (V4_FUZZY_DW.Hpgw_MODE) {
    /* Derivatives for Integrator: '<S69>/pgw_p' */
  ...
  /* End of Derivatives for SubSystem: '<S58>/Hpgw' */

  /* Derivatives for Enabled SubSystem: '<S58>/Hqgw' */
  if (V4_FUZZY_DW.Hqgw_MODE) {
    /* Derivatives for Integrator: '<S70>/qgw_p' */
  ...
  /* End of Derivatives for SubSystem: '<S58>/Hqgw' */

  /* Derivatives for Enabled SubSystem: '<S58>/Hrgw' */
  if (V4_FUZZY_DW.Hrgw_MODE) {
    /* Derivatives for Integrator: '<S71>/rgw_p' */
  ...
  /* End of Derivatives for SubSystem: '<S58>/Hrgw' */
...
void V4_FUZZY::initialize()
{
...

  {
    ...
    /* Start for Enabled SubSystem: '<S59>/Hugw(s)' */
    (void) memset(&(V4_FUZZY_XDis.ug_p_CSTATE), 1,
                  2*sizeof(boolean_T));

    /* End of Start for SubSystem: '<S59>/Hugw(s)' */

    /* Start for Enabled SubSystem: '<S59>/Hvgw(s)' */
    (void) memset(&(V4_FUZZY_XDis.vg_p1_CSTATE), 1,
                  4*sizeof(boolean_T));

    /* End of Start for SubSystem: '<S59>/Hvgw(s)' */

    /* Start for Enabled SubSystem: '<S59>/Hwgw(s)' */
    (void) memset(&(V4_FUZZY_XDis.wg_p1_CSTATE), 1,
                  4*sizeof(boolean_T));

    /* End of Start for SubSystem: '<S59>/Hwgw(s)' */

    /* Start for If: '<S64>/if Height < Max low altitude  elseif Height > Min isotropic altitude ' */
    ...
    /* Start for Enabled SubSystem: '<S58>/Hpgw' */
    (void) memset(&(V4_FUZZY_XDis.pgw_p_CSTATE), 1,
                  2*sizeof(boolean_T));

    /* End of Start for SubSystem: '<S58>/Hpgw' */

    /* Start for Enabled SubSystem: '<S58>/Hqgw' */
    (void) memset(&(V4_FUZZY_XDis.qgw_p_CSTATE), 1,
                  2*sizeof(boolean_T));

    /* End of Start for SubSystem: '<S58>/Hqgw' */

    /* Start for Enabled SubSystem: '<S58>/Hrgw' */
    (void) memset(&(V4_FUZZY_XDis.rgw_p_CSTATE), 1,
                  2*sizeof(boolean_T));

    /* End of Start for SubSystem: '<S58>/Hrgw' */

    /* Start for If: '<S63>/if Height < Max low altitude  elseif Height > Min isotropic altitude ' */
  ...
  if (rtmIsFirstInitCond((&V4_FUZZY_M))) {
    V4_FUZZY_X.Integrator_CSTATE[0] = 20.1;
    ...
    V4_FUZZY_X.Integrator_CSTATE[11] = -1.5;
  }
  ...
  V4_FUZZY_DW.TimeStampA = (rtInf);
  V4_FUZZY_DW.TimeStampB = (rtInf);
  ...
  /* InitializeConditions for RandomNumber: '<S48>/White Noise' */
  ...
  /* SystemInitialize for Enabled SubSystem: '<S59>/Hugw(s)' */
  /* InitializeConditions for Integrator: '<S72>/ug_p' */
  V4_FUZZY_X.ug_p_CSTATE[0] = 0.0;

  /* End of SystemInitialize for SubSystem: '<S59>/Hugw(s)' */

  /* SystemInitialize for Enabled SubSystem: '<S59>/Hvgw(s)' */
  /* InitializeConditions for Integrator: '<S73>/vg_p1' */
  V4_FUZZY_X.vg_p1_CSTATE[0] = 0.0;
  ...
  /* End of SystemInitialize for SubSystem: '<S59>/Hvgw(s)' */

  /* SystemInitialize for Enabled SubSystem: '<S59>/Hwgw(s)' */
  /* InitializeConditions for Integrator: '<S74>/wg_p1' */
  V4_FUZZY_X.wg_p1_CSTATE[0] = 0.0;
  ...
  /* End of SystemInitialize for SubSystem: '<S59>/Hwgw(s)' */
  ...
  /* SystemInitialize for Enabled SubSystem: '<S58>/Hpgw' */
  /* InitializeConditions for Integrator: '<S69>/pgw_p' */
  V4_FUZZY_X.pgw_p_CSTATE[0] = 0.0;

  /* End of SystemInitialize for SubSystem: '<S58>/Hpgw' */

  /* SystemInitialize for Enabled SubSystem: '<S58>/Hqgw' */
  /* InitializeConditions for Integrator: '<S70>/qgw_p' */
  V4_FUZZY_X.qgw_p_CSTATE[0] = 0.0;

  /* End of SystemInitialize for SubSystem: '<S58>/Hqgw' */

  /* SystemInitialize for Enabled SubSystem: '<S58>/Hrgw' */
  /* InitializeConditions for Integrator: '<S71>/rgw_p' */
  V4_FUZZY_X.rgw_p_CSTATE[0] = 0.0;

  /* End of SystemInitialize for SubSystem: '<S58>/Hrgw' */
